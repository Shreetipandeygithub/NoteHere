package com.example.notehere.adapter
...
import com.example.notehere.databinding.NoteItemLayoutBinding
import com.example.notehere.fragments.HomeFragmentDirections.actionHomeFragmentToUpdateNoteFragment
...
class NoteAdapter(
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val direction= actionHomeFragmentToUpdateNoteFragment(currentNote)
